...
public class InmuebleRestController {
	...
	public ResponseEntity<PagedResources<InmuebleItemResource>> search(
			@RequestParam(name = "categoria", required = false) Long categoriaId, @PageableDefault Pageable pageable,
